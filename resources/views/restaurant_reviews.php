...
foreach ($reviews as $review) {
    ...
    <div class="flex justify_center" id="review-<?= $review['id'] ?>">
        <div class="review justify_center">
            ...
            <div class="review-content">
                ...
                <?php if ($canEdit) { ?>
                    <div class="review-actions">
                        <form method="post" action="/restaurant_reviews/delete_review">
                            <input type="hidden" name="id" value="<?= htmlspecialchars($review['id']) ?>">
                            <input type="hidden" name="restaurant_id"
                                   value="<?= htmlspecialchars($review['restaurant_id']) ?>">
            ...
            <?php if ($canEdit) { ?>
                <form class="edit-restaurant-review-form" data-review-id="<?= $review['id'] ?>" style="display:none;">
                    <input type="hidden" name="id" value="<?= htmlspecialchars($review['id']) ?>">
